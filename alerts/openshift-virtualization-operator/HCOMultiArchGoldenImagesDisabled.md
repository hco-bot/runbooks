...
nodes of different architectures) while the multi-architecture feature is
disabled.
...
* In versions earlier than v4.23.0, the result
...
1. open the editor to edit the `HyperConverged` CR:
   ...
   $ oc edit hyperconverged -n "${NAMESPACE}" kubevirt-hyperconverged -o yaml
   ```
